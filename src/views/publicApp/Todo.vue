<template>
  <div id="todo-view">
    ...
    <!-- <state-msger
    v-if="!this.$root.account.currentUser" state="warning">
      <h2>Demo version.</h2>
    ...
    methods: {
      ...
      saveNewDoc() {
        ...
        if (this.newDoc.content) {
          ...
          const date = this.$root.firebase.firestore.Timestamp.fromDate(
            new Date()
          )
          ...
          this.mainStateMsg =
            "The content is empty. This document is not saved."
        }
      },
