    ...
    <div class="contents">
      <section id="colorControlers">
        <div>
          ...
          <span
            class="noticeMsg"
          >Control the Hue, Saturation, Ligthness bar to change colors.</span>
        ...
        <div>
          ...
          <span
            class="noticeMsg"
          >Sorry, RGB control is not supported yet.</span>
          <div
            id="rgbControl"
      ...
      <div id="color-show">
        ...
        >
          ...
          <input
            v-else
            v-model="colorShowText"
            class="input-part"
            placeholder="Write me."
            @keyup.enter="editColorShowText()"
          >
          <i
            id="color-show-edit"
            class="fas fa-pencil-alt"
            @click="editColorShowText()"
          />
        </div>
      </div>
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      getColor(hue, sat, light) {
        ...
        document
          .getElementById("app")
          .style.setProperty("--second-color", second)
      },
      getRGB() {
...
<style lang="scss" scoped>
  ...
  // 2. Concept color
  $degree: 10;
  @function hueControl($degree, $divine, $divineOrder) {
    $result: $degree + (math.div(360, $divine) * $divineOrder);
    @return $result % 360;
  }
  ...
  $first: hsl(hueControl($degree, 6, 0), $s, $l);
  $second: hsl(hueControl($degree, 6, 1), $s, $l);
  $third: hsl(hueControl($degree, 6, 2), $s, $l);
  $forth: hsl(hueControl($degree, 6, 3), $s, $l);
  $fifth: hsl(hueControl($degree, 6, 4), $s, $l);
  $six: hsl(hueControl($degree, 6, 5), $s, $l);
