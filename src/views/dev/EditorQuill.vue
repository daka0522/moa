    ...
    <form id="firestoreDB">
      ...
      <div>
        ...
        >
          ...
          <option
            v-for="item in $root.collections.list"
            :key="item"
          >
            {{ item }}
          </option>
...
<script>
  export default {
    ...
    watch: {
      ...
      docTitle(newValue) {
        this.currentDoc = this.docData[this.docField].find(
          (elem) => elem.title === newValue
        )
    ...
    methods: {
          ...
          docRef
            ...
            .then((snapshot) => {
              ...
              if (snapshot.exists) {
                ...
                let data = new Object()
                data[this.docField] =
                  this.firestore.FieldValue.arrayUnion(currentDoc)
      ...
      deleteDoc() {
        ...
        let data = new Object()
        data[this.docField] = this.firestore.FieldValue.arrayRemove(
          this.currentDoc
        )
...
<style scoped>
  ...
  section {
    box-shadow: 0 0 0.5em 0.1em rgb(202, 202, 202);
    padding: 1em;
    min-height: 10em;
  }
